(ns pdg.async-request-builder
  (:require [pdg.query :as query]
            [pdg.encoders.core :as encoders]
            [pdg.log :refer [info]]
            [pdg.url-matcher :as matcher]
            [pdg.extractor :refer [traverse has-multiples extract-multiple]]
